import { ArrowLeft, Calendar, FileText, Home, Users } from "lucide-react"
...
export default function AdminLayout({
  ...
  const navItems = [
    { path: "/admin/users", label: "직원 관리", icon: <Users className="mr-2 h-5 w-5" /> },
    { path: "/admin/work-logs", label: "근무내역 관리", icon: <Calendar className="mr-2 h-5 w-5" /> },
    { path: "/admin/salary-report", label: "급여 보고서", icon: <FileText className="mr-2 h-5 w-5" /> },
  ]
